function [FEVD_array,cov_array,OIRF_array] = RFVAR_var_analysis(horizon,pphi,Ssigma_array,model)
...
OIRF_array = zeros(N,N,horizon,M1,M2);
...
for m1 = 1:M1
	for m2 = 1:M2
		...
		%% Pick up IRF
		for h = 0:horizon
			OIRF_array(:,:,h,m1,m2) = Ppsi_L.Coefficients{h}*L;
		end
